    ...
    switch(m_type){
        ...
        case METAL:
        {
			...
			if (cosalpha > 0.0f) {
				...
				// The proportion of the refraction part, F, has been considered in the specular item, so the refraction part does not need to be multiplied by ks_ （ks_ * Ks * specular）
